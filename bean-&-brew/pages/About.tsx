...
export const About = () => {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Founder Section */}
      <section className="bg-surface-light dark:bg-surface-dark py-16 px-4 md:px-10 lg:px-20 border-y border-border-light dark:border-border-dark">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-10">
             <div className="w-48 h-48 flex-shrink-0 rounded-full overflow-hidden border-4 border-primary/20">
                <img 
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuANI3aNqmTBx-Nv7Ek70ameieg9RcKb7QqeF8lf46Q2hBAmhxPzLp8wfQebv7s_5QuJcZ5g2i4bnkn_jHEH7r4N3mgusfJH367y9p7fgve7_1KnX6ubPnP09G13MwNR4V1-xuv8GjGC-dYKOg_uXDpfB2v3ho0hAKzTmMo2e5JapzxinCKHoHZdavenKBWwdW2d8FcKuIbFi7hFIUwyzYrQyl1RcYWEeCpZR3ZryZGBOPRjPF5knCxwIHa13eZfqqE4i8ZyyWIRAwHy" 
                    alt="Founder" 
             ...
             <div className="text-center md:text-left">
                ...
                <h3 className="text-primary font-bold mb-4">Jane Doe, Chief Roaster</h3>
                <p className="text-subtle-light dark:text-subtle-dark leading-relaxed italic text-lg">
                    "My journey into coffee began not in a cafe, but on a small farm in Colombia. Seeing the dedication behind each bean inspired me to build a company that honors that hard work. Our mission is simple: to share the world's most incredible coffees with you, roasted to perfection."
                </p>
             </div>
        </div>
      </section>
